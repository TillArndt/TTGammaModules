// -*- C++ -*-
//
// Package:    TTGammaMergerLegacy
// Class:      TTGammaMergerLegacy
// 
/**\class TTGammaMergerLegacy TTGammaMergerLegacy.cc MyPackage/TTGammaMerger/src/TTGammaMergerLegacy.cc
...
// $Id: TTGammaMergerLegacy.cc,v 1.5 2013/06/13 18:57:15 htholen Exp $
//
//
...
class TTGammaMergerLegacy : public edm::EDFilter {
   public:
      explicit TTGammaMergerLegacy(const edm::ParameterSet&);
      ~TTGammaMergerLegacy();
...
//
TTGammaMergerLegacy::TTGammaMergerLegacy(const edm::ParameterSet& iConfig) :
...
TTGammaMergerLegacy::~TTGammaMergerLegacy()
{
}
...
bool
TTGammaMergerLegacy::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace edm;
    using namespace std;
        ...
        if (photon->pt() > ptCut_) {
            for (unsigned j = 0; j < legs.size(); ++j) {
                ...
                if (deltaR(*photon, *leg) > drCut_) {
                    ...
                    cout << "<TTGammaMergerLegacy>: removing Event! "
...
void 
TTGammaMergerLegacy::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
TTGammaMergerLegacy::endJob() {
}

// ------------ method called when starting to processes a run  ------------
bool 
TTGammaMergerLegacy::beginRun(edm::Run&, edm::EventSetup const&)
{ 
  return true;
}
...
bool 
TTGammaMergerLegacy::endRun(edm::Run&, edm::EventSetup const&)
{
  return true;
}
...
bool 
TTGammaMergerLegacy::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
bool 
TTGammaMergerLegacy::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
  return true;
}
...
void
TTGammaMergerLegacy::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(TTGammaMergerLegacy);
